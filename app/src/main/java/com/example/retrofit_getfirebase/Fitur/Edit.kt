package com.example.retrofit_getfirebase.Fitur
...
import com.example.retrofit_getfirebase.Mahasiswa
import com.example.retrofit_getfirebase.R
        ...
        btnUpdate.setOnClickListener {
            ...
            btnUpdate.setOnClickListener {
                ...
                if (updatedNama.isNotEmpty() &&
                    ...
                    database.child(nim).updateChildren(updatedData).addOnSuccessListener {
                            Toast.makeText(this@Edit, "Data updated successfully",
                                Toast.LENGTH_SHORT).show()
                                    finish()
                        }
                        .addOnFailureListener {
                            Toast.makeText(this@Edit, "Failed to update data"
                                , Toast.LENGTH_SHORT).show()
                        }
                } else {
                    Toast.makeText(this@Edit, "Please fill in all fields"
                        , Toast.LENGTH_SHORT).show()
                }
            }
        }
